# x-flags
X's latest feature allows us to see users countries.

This script makes it so you can see their country code on any post in the wild.

# How to use
To put it simply to use the script install violentmonkey for your browser.
Grab it [here](https://violentmonkey.github.io/get-it/).
